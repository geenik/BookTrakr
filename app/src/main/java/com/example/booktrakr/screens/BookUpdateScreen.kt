...
import com.example.booktrakr.utils.formatDate
                ...
                FirebaseFirestore.getInstance()
                    ...
                    .addOnCompleteListener {
                        if (it.isSuccessful) {
                            ...
                            navController.popBackStack(ReaderScreens.ReaderHomeScreen.name, false)
                            navController.navigate(ReaderScreens.ReaderHomeScreen.name)
                        }
                    }
...
fun CardListItem(
    ...
    Card(
        ...
        Row(modifier = Modifier.align(CenterHorizontally),horizontalArrangement = Arrangement.Start,) {
            Image(
